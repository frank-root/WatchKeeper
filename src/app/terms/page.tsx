    ...
    <main className="maritime-page min-h-screen text-[#143141]">
      ...
      <article id="main-content" tabIndex={-1} className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-14">
        <header className="maritime-panel border-l-8 border-l-[#007f68] p-6 sm:p-8">
          <h1 className="text-4xl font-black tracking-tight text-[#050f18] sm:text-5xl">Terms of Service</h1>
        ...
        <section className="maritime-panel space-y-3 border-t-4 border-t-[#93c01f] p-6">
          <h2 className="text-2xl font-black text-[#050f18]">What Watchkeeper is</h2>
        ...
        <section className="maritime-panel space-y-3 border-t-4 border-t-[#0088a8] p-6">
          <h2 className="text-2xl font-black text-[#050f18]">The important one: reminders are a backup, not a guarantee</h2>
          <p className="leading-relaxed text-[#2e4b56]">
            <strong className="text-[#050f18]">
        ...
        <section className="maritime-panel space-y-3 border-t-4 border-t-[#007f68] p-6">
          <h2 className="text-2xl font-black text-[#050f18]">Not affiliated with any authority</h2>
          <p className="leading-relaxed text-[#2e4b56]">
        ...
        <section className="maritime-panel space-y-3 border-t-4 border-t-[#93c01f] p-6">
          <h2 className="text-2xl font-black text-[#050f18]">Your account</h2>
        ...
        <section className="maritime-panel space-y-3 border-t-4 border-t-[#0088a8] p-6">
          <h2 className="text-2xl font-black text-[#050f18]">The service today</h2>
          <p className="leading-relaxed text-[#2e4b56]">
        ...
        <section className="maritime-panel space-y-3 border-t-4 border-t-[#007f68] p-6">
          <h2 className="text-2xl font-black text-[#050f18]">Disclaimers and liability</h2>
          <p className="leading-relaxed text-[#2e4b56]">
        ...
        <section className="maritime-panel space-y-3 border-t-4 border-t-[#93c01f] p-6">
          <h2 className="text-2xl font-black text-[#050f18]">Governing law</h2>
          <p className="leading-relaxed text-[#2e4b56]">These terms are governed by the laws of the State of Washington, USA.</p>
        </section>
