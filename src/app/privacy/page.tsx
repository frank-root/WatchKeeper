    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <article id="main-content" className="mx-auto max-w-3xl space-y-10 px-6 py-16 text-slate-300 sm:py-20">
        ...
        <section className="space-y-3">
          ...
          <p className="leading-relaxed">Watchkeeper stores only what the service needs to work:</p>
          ...
          <p className="leading-relaxed">We do not collect payment information, location data, or analytics profiles, and we do not use advertising trackers.</p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="leading-relaxed">Watchkeeper runs on a small set of service providers, each handling only what their role requires:</p>
          <ul className="list-disc space-y-1 pl-6 leading-relaxed">
